...
function newexp (batch_name,exp_name)
  ...
  runsdir = '/Volumes/Kilchoman/UCLA/Projects/MITgcm_LC/experiments';
  ...
  sNy = 400; %%% no. of y-gridpoints per tile
...
%    acct = 'ddp258';
  ...
  switch(cluster)
    ...
    otherwise %%% Defaults to 'none'
      ...
      username = '';
      clustername = '';
      toolsdir = '~/UCLA/Projects/MITgcm_LC/tools/';
      clusterdir = fullfile('/Volumes/Kilchoman/UCLA/Projects/MITgcm_LC/experiments/',batch_name);  
